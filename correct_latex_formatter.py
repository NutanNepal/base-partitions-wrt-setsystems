...
def convert_to_latex_correct(polynomial_str):
    """
    Convert a polynomial string to LaTeX format correctly.
    """
    # Fix common typos
    polynomial_str = polynomial_str.replace('XX7', 'X7')
    polynomial_str = polynomial_str.replace('XX5', 'X5')
