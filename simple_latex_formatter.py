def convert_to_latex(polynomial_str):
    """
...
print("LaTeX version:")
print(convert_to_latex(test_polynomial))
print()
...
latex_result = convert_to_latex(full_polynomial)

# Save to file for easier copying
with open('polynomial_latex.txt', 'w') as f:
    f.write(latex_result)

print("LaTeX polynomial saved to 'polynomial_latex.txt'")
